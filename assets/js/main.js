...
let svgI = svgW / 422; // 190 = viewBox="..X..X.190..X"
...
clickMenu.forEach((subMenu) => {
   subMenu.addEventListener('click', () => {
      let clickedUl = subMenu.querySelector('ul');
      clickedUl.classList.toggle('show-submenu');
      subMenu.querySelector('span').classList.toggle('arrow-rotate', clickedUl.classList.contains('show-submenu'));
   });
});
